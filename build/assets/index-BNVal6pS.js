 ...
 */var Bm;function gw(){if(Bm)return _e;Bm=1;var t=Symbol.for("react.element"),r=Symbol.for("react.portal"),o=Symbol.for("react.fragment"),i=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),d=Symbol.for("react.provider"),u=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),g=Symbol.for("react.suspense"),v=Symbol.for("react.memo"),y=Symbol.for("react.lazy"),x=Symbol.iterator;function b(_){return _===null||typeof _!="object"?null:(_=x&&_[x]||_["@@iterator"],typeof _=="function"?_:null)}var C={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},k=Object.assign,S={};function N(_,j,B){this.props=_,this.context=j,this.refs=S,this.updater=B||C}N.prototype.isReactComponent={},N.prototype.setState=function(_,j){if(typeof _!="object"&&typeof _!="function"&&_!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,_,j,"setState")},N.prototype.forceUpdate=function(_){this.updater.enqueueForceUpdate(this,_,"forceUpdate")};function P(){}P.prototype=N.prototype;function M(_,j,B){this.props=_,this.context=j,this.refs=S,this.updater=B||C}var L=M.prototype=new P;L.constructor=M,k(L,N.prototype),L.isPureReactComponent=!0;var D=Array.isArray,$=Object.prototype.hasOwnProperty,W={current:null},O={key:!0,ref:!0,__self:!0,__source:!0};function U(_,j,B){var H,T={},A=null,E=null;if(j!=null)for(H in j.ref!==void 0&&(E=j.ref),j.key!==void 0&&(A=""+j.key),j)$.call(j,H)&&!O.hasOwnProperty(H)&&(T[H]=j[H]);var Q=arguments.length-2;if(Q===1)T.children=B;else if(1<Q){for(var Z=Array(Q),ue=0;ue<Q;ue++)Z[ue]=arguments[ue+2];T.children=Z}if(_&&_.defaultProps)for(H in Q=_.defaultProps,Q)T[H]===void 0&&(T[H]=Q[H]);return{$$typeof:t,type:_,key:A,ref:E,props:T,_owner:W.current}}function ne(_,j){return{$$typeof:t,type:_.type,key:j,ref:_.ref,props:_.props,_owner:_._owner}}function oe(_){return typeof _=="object"&&_!==null&&_.$$typeof===t}function ae(_){var j={"=":"=0",":":"=2"};return"$"+_.replace(/[=:]/g,function(B){return j[B]})}var ce=/\/+/g;function pe(_,j){return typeof _=="object"&&_!==null&&_.key!=null?ae(""+_.key):j.toString(36)}function se(_,j,B,H,T){var A=typeof _;(A==="undefined"||A==="boolean")&&(_=null);var E=!1;if(_===null)E=!0;else switch(A){case"string":case"number":E=!0;break;case"object":switch(_.$$typeof){case t:case r:E=!0}}if(E)return E=_,T=T(E),_=H===""?"."+pe(E,0):H,D(T)?(B="",_!=null&&(B=_.replace(ce,"$&/")+"/"),se(T,j,B,"",function(ue){return ue})):T!=null&&(oe(T)&&(T=ne(T,B+(!T.key||E&&E.key===T.key?"":(""+T.key).replace(ce,"$&/")+"/")+_)),j.push(T)),1;if(E=0,H=H===""?".":H+":",D(_))for(var Q=0;Q<_.length;Q++){A=_[Q];var Z=H+pe(A,Q);E+=se(A,j,B,Z,T)}else if(Z=b(_),typeof Z=="function")for(_=Z.call(_),Q=0;!(A=_.next()).done;)A=A.value,Z=H+pe(A,Q++),E+=se(A,j,B,Z,T);else if(A==="object")throw j=String(_),Error("Objects are not valid as a React child (found: "+(j==="[object Object]"?"object with keys {"+Object.keys(_).join(", ")+"}":j)+"). If you meant to render a collection of children, use an array instead.");return E}function X(_,j,B){if(_==null)return _;var H=[],T=0;return se(_,H,"","",function(A){return j.call(B,A,T++)}),H}function Y(_){if(_._status===-1){var j=_._result;j=j(),j.then(function(B){(_._status===0||_._status===-1)&&(_._status=1,_._result=B)},function(B){(_._status===0||_._status===-1)&&(_._status=2,_._result=B)}),_._status===-1&&(_._status=0,_._result=j)}if(_._status===1)return _._result.default;throw _._result}var le={current:null},z={transition:null},K={ReactCurrentDispatcher:le,ReactCurrentBatchConfig:z,ReactCurrentOwner:W};function J(){throw Error("act(...) is not supported in production builds of React.")}return _e.Children={map:X,forEach:function(_,j,B){X(_,function(){j.apply(this,arguments)},B)},count:function(_){var j=0;return X(_,function(){j++}),j},toArray:function(_){return X(_,function(j){return j})||[]},only:function(_){if(!oe(_))throw Error("React.Children.only expected to receive a single React element child.");return _}},_e.Component=N,_e.Fragment=o,_e.Profiler=l,_e.PureComponent=M,_e.StrictMode=i,_e.Suspense=g,_e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=K,_e.act=J,_e.cloneElement=function(_,j,B){if(_==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+_+".");var H=k({},_.props),T=_.key,A=_.ref,E=_._owner;if(j!=null){if(j.ref!==void 0&&(A=j.ref,E=W.current),j.key!==void 0&&(T=""+j.key),_.type&&_.type.defaultProps)var Q=_.type.defaultProps;for(Z in j)$.call(j,Z)&&!O.hasOwnProperty(Z)&&(H[Z]=j[Z]===void 0&&Q!==void 0?Q[Z]:j[Z])}var Z=arguments.length-2;if(Z===1)H.children=B;else if(1<Z){Q=Array(Z);for(var ue=0;ue<Z;ue++)Q[ue]=arguments[ue+2];H.children=Q}return{$$typeof:t,type:_.type,key:T,ref:A,props:H,_owner:E}},_e.createContext=function(_){return _={$$typeof:u,_currentValue:_,_currentValue2:_,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},_.Provider={$$typeof:d,_context:_},_.Consumer=_},_e.createElement=U,_e.createFactory=function(_){var j=U.bind(null,_);return j.type=_,j},_e.createRef=function(){return{current:null}},_e.forwardRef=function(_){return{$$typeof:m,render:_}},_e.isValidElement=oe,_e.lazy=function(_){return{$$typeof:y,_payload:{_status:-1,_result:_},_init:Y}},_e.memo=function(_,j){return{$$typeof:v,type:_,compare:j===void 0?null:j}},_e.startTransition=function(_){var j=z.transition;z.transition={};try{_()}finally{z.transition=j}},_e.unstable_act=J,_e.useCallback=function(_,j){return le.current.useCallback(_,j)},_e.useContext=function(_){return le.current.useContext(_)},_e.useDebugValue=function(){},_e.useDeferredValue=function(_){return le.current.useDeferredValue(_)},_e.useEffect=function(_,j){return le.current.useEffect(_,j)},_e.useId=function(){return le.current.useId()},_e.useImperativeHandle=function(_,j,B){return le.current.useImperativeHandle(_,j,B)},_e.useInsertionEffect=function(_,j){return le.current.useInsertionEffect(_,j)},_e.useLayoutEffect=function(_,j){return le.current.useLayoutEffect(_,j)},_e.useMemo=function(_,j){return le.current.useMemo(_,j)},_e.useReducer=function(_,j,B){return le.current.useReducer(_,j,B)},_e.useRef=function(_){return le.current.useRef(_)},_e.useState=function(_){return le.current.useState(_)},_e.useSyncExternalStore=function(_,j,B){return le.current.useSyncExternalStore(_,j,B)},_e.useTransition=function(){return le.current.useTransition()},_e.version="18.3.1",_e}var Hm;function au(){return Hm||(Hm=1,pd.exports=gw()),pd.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Um;function yw(){return Um||(Um=1,(function(t){function r(z,K){var J=z.length;z.push(K);e:for(;0<J;){var _=J-1>>>1,j=z[_];if(0<l(j,K))z[_]=K,z[J]=j,J=_;else break e}}function o(z){return z.length===0?null:z[0]}function i(z){if(z.length===0)return null;var K=z[0],J=z.pop();if(J!==K){z[0]=J;e:for(var _=0,j=z.length,B=j>>>1;_<B;){var H=2*(_+1)-1,T=z[H],A=H+1,E=z[A];if(0>l(T,J))A<j&&0>l(E,T)?(z[_]=E,z[A]=J,_=A):(z[_]=T,z[H]=J,_=H);else if(A<j&&0>l(E,J))z[_]=E,z[A]=J,_=A;else break e}}return K}function l(z,K){var J=z.sortIndex-K.sortIndex;return J!==0?J:z.id-K.id}if(typeof performance=="object"&&typeof performance.now=="function"){var d=performance;t.unstable_now=function(){return d.now()}}else{var u=Date,m=u.now();t.unstable_now=function(){return u.now()-m}}var g=[],v=[],y=1,x=null,b=3,C=!1,k=!1,S=!1,N=typeof setTimeout=="function"?setTimeout:null,P=typeof clearTimeout=="function"?clearTimeout:null,M=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function L(z){for(var K=o(v);K!==null;){if(K.callback===null)i(v);else if(K.startTime<=z)i(v),K.sortIndex=K.expirationTime,r(g,K);else break;K=o(v)}}function D(z){if(S=!1,L(z),!k)if(o(g)!==null)k=!0,Y($);else{var K=o(v);K!==null&&le(D,K.startTime-z)}}function $(z,K){k=!1,S&&(S=!1,P(U),U=-1),C=!0;var J=b;try{for(L(K),x=o(g);x!==null&&(!(x.expirationTime>K)||z&&!ae());){var _=x.callback;if(typeof _=="function"){x.callback=null,b=x.priorityLevel;var j=_(x.expirationTime<=K);K=t.unstable_now(),typeof j=="function"?x.callback=j:x===o(g)&&i(g),L(K)}else i(g);x=o(g)}if(x!==null)var B=!0;else{var H=o(v);H!==null&&le(D,H.startTime-K),B=!1}return B}finally{x=null,b=J,C=!1}}var W=!1,O=null,U=-1,ne=5,oe=-1;function ae(){return!(t.unstable_now()-oe<ne)}function ce(){if(O!==null){var z=t.unstable_now();oe=z;var K=!0;try{K=O(!0,z)}finally{K?pe():(W=!1,O=null)}}else W=!1}var pe;if(typeof M=="function")pe=function(){M(ce)};else if(typeof MessageChannel<"u"){var se=new MessageChannel,X=se.port2;se.port1.onmessage=ce,pe=function(){X.postMessage(null)}}else pe=function(){N(ce,0)};function Y(z){O=z,W||(W=!0,pe())}function le(z,K){U=N(function(){z(t.unstable_now())},K)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(z){z.callback=null},t.unstable_continueExecution=function(){k||C||(k=!0,Y($))},t.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ne=0<z?Math.floor(1e3/z):5},t.unstable_getCurrentPriorityLevel=function(){return b},t.unstable_getFirstCallbackNode=function(){return o(g)},t.unstable_next=function(z){switch(b){case 1:case 2:case 3:var K=3;break;default:K=b}var J=b;b=K;try{return z()}finally{b=J}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(z,K){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var J=b;b=z;try{return K()}finally{b=J}},t.unstable_scheduleCallback=function(z,K,J){var _=t.unstable_now();switch(typeof J=="object"&&J!==null?(J=J.delay,J=typeof J=="number"&&0<J?_+J:_):J=_,z){case 1:var j=-1;break;case 2:j=250;break;case 5:j=1073741823;break;case 4:j=1e4;break;default:j=5e3}return j=J+j,z={id:y++,callback:K,priorityLevel:z,startTime:J,expirationTime:j,sortIndex:-1},J>_?(z.sortIndex=J,r(v,z),o(g)===null&&z===o(v)&&(S?(P(U),U=-1):S=!0,le(D,J-_))):(z.sortIndex=j,r(g,z),k||C||(k=!0,Y($))),z},t.unstable_shouldYield=ae,t.unstable_wrapCallback=function(z){var K=b;return function(){var J=b;b=K;try{return z.apply(this,arguments)}finally{b=J}}}})(gd)),gd}var Gm;function xw(){return Gm||(Gm=1,md.exports=yw()),md.exports}/**
 * @license React
...
Feel free to come back anytime you need help with future PQs. Good luck! 😊`}]}]};function JA(){const[t,r]=f.useState(!1),[o,i]=f.useState(!1),[l,d]=f.useState({name:"Jayden Tan",email:"jayden.tan@tech.gov.sg",role:"Marketing Officer",agency:"GovTech"}),[u,m]=f.useState([]),[g,v]=f.useState("new-rsn"),[y,x]=f.useState(!0),[b,C]=f.useState("light"),[k,S]=f.useState("modern"),[N,P]=f.useState("home"),[M,L]=f.useState("desk"),[D,$]=f.useState(!1),[W,O]=f.useState(0);f.useEffect(()=>{t&&window.history.pushState({authenticated:!0},"");const H=()=>{r(!1),i(!1)};return window.addEventListener("popstate",H),()=>window.removeEventListener("popstate",H)},[t]);const U=g.startsWith("new-")?{id:g,title:g==="new-cce-sn"?"C(CE) Chat":g==="new-cce-sh"?"SH Chat":"New Chat",messages:[],createdAt:new Date,classificationType:g==="new-cce-sn"?"cce-sn":g==="new-cce-sh"?"cce-sh":"rsn"}:u.find(H=>H.id===g),ne=y,oe=async H=>{if(!U)return;let T=u,A=g;const E={id:Date.now().toString(),role:"user",content:H,timestamp:new Date};if(g.startsWith("new-")){const Q=Date.now().toString();T=[{...U,id:Q,title:H.slice(0,30),messages:[E]},...u],m(T),v(Q),A=Q}else T=u.map(Q=>{if(Q.id===g){const Z=[...Q.messages,E];return{...Q,messages:Z,title:Q.messages.length===0?H.slice(0,30):Q.title}}return Q}),m(T);setTimeout(()=>{const Q=T.find(Ne=>Ne.id===A);if(!Q)return;let Z=eh(H,Q.assistantType,l),ue=!1,ke="";Q.assistantType==="transcribe"&&H.includes("[Uploaded file:")&&(Z="I've transcribed your audio file and generated the meeting minutes.",ue=!0,ke="Meeting_Minutes_"+new Date().toLocaleDateString().replace(/\//g,"-")+".doc");const Re={id:(Date.now()+1).toString(),role:"assistant",content:Z,timestamp:new Date,hasFile:ue,fileName:ke};m(Ne=>Ne.map(Fe=>Fe.id===A?{...Fe,messages:[...Fe.messages,Re]}:Fe))},500)},ae=()=>{v("new-rsn"),P("home"),O(H=>H+1)},ce=(H,T)=>{const A=Date.now().toString(),E={id:A,role:"user",content:H,timestamp:new Date},Z=[{id:A,title:H.slice(0,30),messages:[E],createdAt:new Date,classificationType:T||"rsn"},...u];m(Z),v(A),P("chat"),setTimeout(()=>{const ue=eh(H,void 0,l),ke={id:(Date.now()+1).toString(),role:"assistant",content:ue,timestamp:new Date};m(Re=>Re.map(Ne=>Ne.id===A?{...Ne,messages:[...Ne.messages,ke]}:Ne))},500)},pe=()=>{v("new-cce-sn"),P("chat")},se=()=>{v("new-cce-sh"),P("chat")},X=(H,T)=>{if(T==="workday-shortlister"){_("hr-candidate-shortlisting");return}if(T==="parliamentary-question"){_("pq-response-mnd");return}const A={id:Date.now().toString(),title:H,messages:[],createdAt:new Date,assistantType:T};m([A,...u]),v(A.id),P("chat"),setTimeout(()=>{let E="";if(T==="transcribe"?E="Upload an audio to generate a minutes.":T==="powerpoint"&&(E="I can help you create icons and pictures for your PowerPoint slides. What would you like me to generate?"),E){const Q={id:Date.now().toString(),role:"assistant",content:E,timestamp:new Date};m(Z=>Z.map(ue=>ue.id===A.id?{...ue,messages:[Q]}:ue))}},300)},Y=H=>{const T=u.filter(A=>A.id!==H);m(T),g===H&&(T.length>0?v(T[0].id):ae())},le=H=>{v(H),P("chat")},z=()=>{i(!0)},K=()=>{r(!1),i(!1),d({name:"Jayden Tan",email:"jayden.tan@tech.gov.sg",role:"Marketing Officer",agency:"GovTech"}),m([]),P("home"),v("new-rsn")},J=(H,T)=>{d(H),r(!0),T&&(i(!0),m([]))},_=H=>{v(`sim-${H}`),P("chat")},j=g.startsWith("sim-"),B=j?g==="sim-feature-overview"?VA:g==="sim-customer-support"?UA:g==="sim-feedback-collection"?GA:g==="sim-hr-candidate-shortlisting"?QA:g==="sim-procurement-rfq"?qA:g==="sim-marketing-software-aor"?KA:g==="sim-pq-response-mnd"?YA:g==="sim-pq-response-mnd-v2"?XA:null:null;return t?o?a.jsxs("div",{className:"flex h-screen bg-gradient-to-br from-purple-100 via-pink-100 to-blue-100 dark:bg-gradient-to-br dark:from-gray-900 dark:via-purple-950 dark:to-blue-950",children:[a.jsx(sE,{isOpen:ne,onClose:()=>x(!1),chats:u,activeChatId:g,onSelectChat:le,onNewChat:ae,onNewCCESNChat:pe,onNewSHChat:se,onDeleteChat:Y,colorTheme:b,fontStyle:k,onColorThemeChange:C,onFontStyleChange:S,onSettingsOpen:()=>$(!0),mode:M,onModeChange:L,activeView:N,onExploreClick:()=>{P("explore"),v("new-rsn")},onStudioClick:()=>P("studio"),onHomeClick:()=>{P("home"),v("new-rsn")},onViewChange:H=>{P(H),H!=="chat"&&v("new-rsn")},userProfile:l,onSignOut:K,onSelectSimulation:_}),N==="chat"?j&&B?a.jsx("div",{className:"flex-1 flex flex-col",children:a.jsx(Zg,{mode:"simulator",data:B,onToggleSidebar:()=>x(!y)},g)}):a.jsx("div",{className:"flex-1 flex flex-col",children:a.jsx(Zg,{mode:"interactive",title:U?.title,classificationType:U?.classificationType,interactiveMessages:U?.messages||[],onSendMessage:oe,onToggleSidebar:()=>x(!y)},g)}):N==="explore"?a.jsx(gE,{onToggleSidebar:()=>x(!y),colorTheme:b,fontStyle:k,onStartAssistantChat:X,userRole:l?.role}):N==="studio"?a.jsx(bE,{onToggleSidebar:()=>x(!y),colorTheme:b,fontStyle:k}):N==="library"?a.jsx(u3,{onToggleSidebar:()=>x(!y),colorTheme:b,fontStyle:k}):N==="chats"?a.jsx(f3,{onToggleSidebar:()=>x(!y),colorTheme:b,fontStyle:k,chats:u,onSelectChat:le,onDeleteChat:Y,onSelectSimulation:_}):a.jsx(g3,{colorTheme:b,fontStyle:k,onSelectChat:le,onNewChat:ae,onStartChat:ce,onToggleSidebar:()=>x(!y),isSidebarOpen:y,userProfile:l,onSelectSimulation:_},W),a.jsx(mA,{colorTheme:b,fontStyle:k,onColorThemeChange:C,onFontStyleChange:S,userProfile:l,onUpdateProfile:d,open:D,onOpenChange:$})]}):a.jsx(JR,{userProfile:l,onUpdateProfile:d,onComplete:z}):a.jsx(h3,{onLogin:J})}function eh(t,r,o){if(r==="transcribe"&&(t.toLowerCase().includes("what was the follow up")||t.toLowerCase().includes("follow-up")||t.toLowerCase().includes("action")))return`Based on the meeting minutes, here are the follow-up actions:
